...
public class TipoProdutoController {
  ...
  @Operation(summary = "Lista administrativa de tipos de produto com paginação")
  @ApiResponses({
          @ApiResponse(
                  responseCode = "200",
                  description = "Página de tipos de produto listada")
  })
  @GetMapping("/paged")
  public ResponseEntity<Page<TipoProdutoResponse>> findAllPaged(
          @PageableDefault(size = 5) Pageable pageable) {
    return ResponseEntity.ok(tipoProdutoService.findAllPaged(pageable));
  }
